...
_USAGE = {
    "cz": "Пришли текст: /tcz Мне нужно продлить проездной\n"
          "Или ответь командой /tcz на сообщение, которое перевести.",
    "eng": "Пришли текст: /teng Мне нужно перенести встречу\n"
           "Или ответь командой /teng на сообщение, которое перевести.",
}
